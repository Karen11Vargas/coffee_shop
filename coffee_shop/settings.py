...
SECRET_KEY = 'django-insecure-dm_&g(_tnxq^(6lpp*0%n3=y=)h&bnxaqr%&b$1#oxtmqvr2t1'
...
# Base url to serve media files ``' ``# Path where media is stored ``MEDIA_ROOT = os.path.``join``(BASE_DIR, "media")
